...
namespace Windows.Admin.Application
{
    public class ModuleService : BaseService, IModuleService
    {
        ...
        public ModuleService(AdminDbContext db,IMapper mapper)
        {
            _mapper = mapper;
            _db = db;
        }
        ...
        /// <returns></returns>
        public List<Module> GetListByPrivilegeIds(List<int> privilegeIds)
        {
            using (_db)
            {
                ...
                List<Module> modules = _db.Module.WhereByModuleIds(moduleIds).ToList();
                return modules;
            }
        }
        ...
        /// <param name="id"></param>
        private void GetChildrenModuleIdList(List<Module> modules, List<int> idList, int pId)
        {
